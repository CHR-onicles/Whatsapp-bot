...
const execute = (client, msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isBotAdmin) {
        yield msg.reply("Err... you're kinda already a bot admin 🐦");
        return;
    }
    else {
        yield (0, misc_1.addBotAdmin)(contact.id.user);
        yield msg.reply("You've successfully added yourself as a bot admin ✅");
    }
});
module.exports = {
    name: "selfpromote",
    ...
    alias: ["sprom"],
    category: "admin",
    help: `To use this command, type:\n*${helpers_1.currentPrefix}selfpromote*`,
    execute,
};
